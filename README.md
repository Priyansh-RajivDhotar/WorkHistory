...
This repository stores project journey documents, executive summaries, and supporting learning materials.
...
- Binary files such as `.docx` and `.pptx` are stored as reference materials.
- The markdown summary can be viewed directly in GitHub.
